...
class OpenGLShape {
  ...
  protected:
     ...
     * don't worry about what exactly this function is doing, you'll learn more about that later in
     * the course! look at ExampleShape.cpp for it's demonstrated usage
     */
